  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.featureItem}>• Review system for study locations</Text>
        <Text style={styles.featureItem}>• Ratings (coffee, noise, seating, power outlets)</Text>
        <Text style={styles.featureItem}>• Dedicated favorites feature (save preferred spots)</Text>
        <Text style={styles.featureItem}>• Advanced productivity analytics</Text>
      </View>
